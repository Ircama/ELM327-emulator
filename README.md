...
*obd* (*python-OBD*) is needed for *obd_dictionary*. It is better to use an updated version of *python-OBD* package (e.g., the one installed from GitHub with `python3 -m pip install git+https://github.com/brendan-w/python-OBD.git`).
