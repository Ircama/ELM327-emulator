...
At the command prompt, cursors and [keyboard shortcuts](https://ss64.com/bash/syntax-keyboard.html) are allowed. Autocompletion (via TAB key) is active for all previously described commands and also allows Python keywords, built-ins and globals.
