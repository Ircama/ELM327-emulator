...
A python emulator for the ELM327 OBD-II adapter. It allows testing [python-OBD](https://github.com/brendanwhitfield/python-OBD).

This emulator can process examples in [*python-OBD* documentation](https://python-obd.readthedocs.io/en/latest/) and by default reproduces the message flow
